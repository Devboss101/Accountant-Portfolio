...
# SECRET_KEY = 'django-insecure-hz*m7+%xiw)abb%9@^+5p)9o^!!yzsc+e_arl$fe!nj-67rj)*'
...
# STATICFILES_DIRS = [BASE_DIR / 'core' / 'static']  # add this line
...
# EMAIL_PORT          = 587
# EMAIL_USE_TLS       = True
# EMAIL_HOST_USER     = 'simplifieddani@gmail.com'      # her Gmail address
# EMAIL_HOST_PASSWORD = 'xxxx xxxx xxxx xxxx'      # Gmail App Password (see note below)
